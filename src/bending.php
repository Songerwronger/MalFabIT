...
<style>
    body {
        background-image: url('fabbackg.gif');
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">Bending</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">If you need precise, professional metal bends, then we are your stop, get in touch and let us know what your specific needs are.</p>
    </div>
     ...
     <img src="wave (1) (1).svg" alt="" class="wave">
          ...
          <div class="ourgal fsphone-2h ipadsize"><p class="fs-1 fsphone-1h ipadsize">SOME OF OUR WORK</p></div>
            ...
            <div class="carouselcus">
              <img src="metalbendimgs/1.jpg" alt="Image 1">
              <img src="metalbendimgs/4.jpg" alt="Image 2">
              <img src="metalbendimgs/3.jpg" alt="Image 3">
              <img src="metalbendimgs/2.jpg" alt="Image 4">
            </div>
