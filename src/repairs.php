...
<style>
    body {
        background-image: url('itrepimg.png');
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">PC + Laptop Repairs</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">Need some repairs/hardware changes made to your old system? Maybe you want to upgrade but you’re not sure how and need some help, no matter what, we can help.</p>
    </div>
    ...
    <div class="carousel-inner" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.1); padding: 40px;">
      ...
      <div class="carousel-item active">
        <img src="pcrepairimgs/1.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 1">
      </div>
      <!-- Image 2 -->
      <div class="carousel-item">
        <img src="pcrepairimgs/2.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 2">
      </div>
      <!-- Image 3 -->
      <div class="carousel-item">
        <img src="pcrepairimgs/3.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 3">
      </div>
      <!-- Image 4 -->
      <div class="carousel-item">
        <img src="pcrepairimgs/4.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 4">
      </div>
    </div>
