...
<style>
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">Fabrication</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">We can do assembly using common materials like steel, please get in touch to let us know your specific needs.</p>
    </div>
     ...
     <img src="wave (1) (1).svg" alt="" class="wave">
          ...
          <div class="ourgal fsphone-2h ipadsize"><p class="fs-1 fsphone-1h ipadsize">SOME OF OUR WORK</p></div>
            ...
            <div class="carouselcus">
              <img src="fabricimgs/1.jpg" alt="Image 1">
              <img src="fabricimgs/2.jpg" alt="Image 2">
              <img src="fabricimgs/3.jpg" alt="Image 3">
              <img src="fabricimgs/4.jpg" alt="Image 4">
            </div>
