...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="carousel-indicators">
      ...
      <button type="button" data-bs-target="#imageCarousel" data-bs-slide-to="4" aria-label="Image 5"></button>
    </div>
    <div class="carousel-inner" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.1); padding: 40px;">
      <!-- Image 1 -->
      <div class="carousel-item active">
        <img src="webuyings/1.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 1">
      </div>
      <!-- Image 2 -->
      <div class="carousel-item">
        <img src="webuyings/2.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 2">
      </div>
      <!-- Image 3 -->
      <div class="carousel-item">
        <img src="webuyings/3.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 3">
      </div>
      <!-- Image 4 -->
      <div class="carousel-item">
        <img src="webuyings/4.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 4">
      </div>
      <!-- Image 5 -->
      <div class="carousel-item">
        <img src="webuyings/5.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 5">
      </div>
    </div>
