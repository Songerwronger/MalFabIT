...
<style>
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">Welding</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">Pipes need joining? Need a hanging car exhaust put back together, then get in touch. Please get in touch to let us know your specific needs.</p>
    </div>
     ...
     <img src="wave (1) (1).svg" alt="" class="wave">
          ...
          <div class="ourgal fsphone-2h ipadsize"><p class="fs-1 fsphone-1h ipadsize">SOME OF OUR WORK</p></div>
            ...
            <div class="carouselcus">
              <img src="weldimgs/1.jpg" alt="Image 1">
              <img src="weldimgs/2.jpg" alt="Image 2">
              <img src="weldimgs/3.jpg" alt="Image 3">
              <img src="weldimgs/4.jpg" alt="Image 4">
            </div>
