...
<style>
    body {
        background-image: url('pcbuild.jpg');
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">Custom PC Builds</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">Is your child begging you for a new “Gaming PC”? Are you a business that needs a new system to manage everyday data input tasks, well that’s where come in, were here to deal with all that and everything in between, get in touch with us via E-mail for your needs and a suited quote</p>
    </div>




    <div id="imageCarousel" class="carousel text-lr-space small-screen-margin mx-auto" data-bs-ride="carousel">
    <div class="carousel-indicators">
      ...
      <button type="button" data-bs-target="#imageCarousel" data-bs-slide-to="1" aria-label="Image 2"></button>
      <button type="button" data-bs-target="#imageCarousel" data-bs-slide-to="2" aria-label="Image 3"></button>
      <button type="button" data-bs-target="#imageCarousel" data-bs-slide-to="3" aria-label="Image 4"></button>
    </div>
    <div class="carousel-inner" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.1); padding: 40px;">
      <!-- Image 1 -->
      <div class="carousel-item active">
        <img src="cuspcimgs/1.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 1">
      </div>
      <!-- Image 2 -->
      <div class="carousel-item">
        <img src="Casting.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 2">
      </div>
      <!-- Image 3 -->
      <div class="carousel-item">
        <img src="cuspcimgs/3.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 3">
      </div>
      <!-- Image 4 -->
      <div class="carousel-item">
        <img src="cuspcimgs/4.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 4">
      </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#imageCarousel" data-bs-slide="prev" style="width: 5%; left: -5%;">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#imageCarousel" data-bs-slide="next" style="width: 5%; right: -5%;">
