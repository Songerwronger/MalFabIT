...
<style>
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
     ...
     <img src="wave (1) (1).svg" alt="" class="wave">
          ...
          <div class="imgcover">
            <div class="ourgal fsphone-2h ipadsize"><p class="fs-1 fsphone-1h ipadsize">SOME OF OUR WORK</p></div>
            <i id="left" class="fa-solid fa-angle-left"></i>
            <div class="carouselcus">
              <img src="cuspcimgs/1.jpg" alt="Image 1">
              <img src="cuspcimgs/2.jpg" alt="Image 2">
              <img src="cuspcimgs/3.jpg" alt="Image 3">
              <img src="cuspcimgs/4.jpg" alt="Image 4">
              <img src="cuspcimgs/5.jpg" alt="Image 5">
              <img src="cuspcimgs/6.jpg" alt="Image 6">
              <img src="cuspcimgs/7.jpg" alt="Image 7">
              <img src="cuspcimgs/8.jpg" alt="Image 8">
            </div>
