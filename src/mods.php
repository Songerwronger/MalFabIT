...
<style>
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        ...
        <p class="mt-6 h3 fs-1h fsphone-1h">Need some mods doing? Maybe you’ve had a dodgy job done and need the right man? You can rely on us.  </p>
    </div>
     ...
     <img src="wave (1) (1).svg" alt="" class="wave">
          ...
          <div class="ourgal fsphone-2h ipadsize"><p class="fs-1 fsphone-1h ipadsize">SOME OF OUR WORK</p></div>
            ...
            <div class="carouselcus">
              <img src="modsimgs/1.jpg" alt="Image 1">
              <img src="modsimgs/2.jpg" alt="Image 2">
              <img src="modsimgs/3.jpg" alt="Image 3">
            </div>
