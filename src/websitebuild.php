...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="text-white position-absolute z-1 centerr text-center txtshadowblack">
        <h1 class="mt-5">Custom Website Development</h1>
        <p class="mt-6 h3 fs-1h fsphone-1h">
            With speciality in front and back end development using languages such as HTML, CSS (Bootstrap Framework) JavaScript, React, NodeJS and PostgreSQL, youre in safe hands with us, and we will bring your idea to life. 
            </p>
    </div>
    ...
    <div class="carousel-inner" style="border-radius: 1rem; background-color: rgba(255, 255, 255, 0.1); padding: 40px;">
      ...
      <div class="carousel-item active">
        <img src="webdev/1.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 1">
      </div>
      <!-- Image 2 -->
      <div class="carousel-item">
        <img src="webdev/2.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 2">
      </div>
      <!-- Image 3 -->
      <div class="carousel-item">
        <img src="webdev/3.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 3">
      </div>
      <!-- Image 4 -->
      <div class="carousel-item">
        <img src="webdev/4.jpg" class="d-block w-100" style="border-radius: 1rem;" alt="Image 4">
      </div>
    </div>
